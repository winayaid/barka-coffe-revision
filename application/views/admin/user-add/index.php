			...
			<div class="flex justify-center">
				<div class="w-1/2">
					...
					<div class="my-2">
						...
						<input type="text" id="nama" name="nama" required class="border border-gray-300 rounded-lg px-4 py-2 w-full">
					</div>
					<div class="my-2">
						<label for="email" class="block">Email</label>
						<input type="email" id="email" name="email" required class="border border-gray-300 rounded-lg px-4 py-2 w-full">
					</div>
					<div class="mb-4">
