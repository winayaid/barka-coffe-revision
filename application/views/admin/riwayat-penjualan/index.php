            ...
            <div class="bg-white">
                <table class="w-full">
                    <tr>
                        ...
                        <th class="bg-primary py-4 text-white">Total Harga</th>
                        <th class="bg-primary py-4 text-white">Status</th>
                        <th class="bg-primary py-4 text-white" colspan="2">Aksi</th>
                    </tr>
                    ...
                    <tr class="border">
                        ...
                        <td class="p-5">
                            <div class="flex space-x-2 items-center">
                                ...
                                <?php endif; ?>
                                <a href="<?= base_url('penjulan/detail/') ?><?= $row->id_penjualan ?>"
                                    class="bg-blue-600 text-white p-2 rounded-md w-28 text-center">Detail</a>
                            </div>
                        </td>
                    </tr>
                    <?php endforeach; ?>
